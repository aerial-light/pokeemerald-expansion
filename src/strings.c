...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("");
const u8 gText_ExpandedPlaceholder_May[] = _("");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pPorf. Birch's Pokédex rating!\pProf. Birch: Let's see…\p");
