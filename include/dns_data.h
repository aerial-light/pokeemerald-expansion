...
#define OW_BG_PAL_13 TRUE
#define OW_BG_PAL_14 TRUE
#define OW_BG_PAL_15 TRUE
...
//Day has no fade
	...
	[17]  = {
			{RGB(26, 9, 1), 5},	//5:00 PM
			{RGB(26, 9, 1), 5},	//5:10 PM
			{RGB(26, 9, 1), 5},	//5:20 PM
			{RGB(26, 9, 1), 5},	//5:30 PM
			{RGB(26, 9, 1), 5},	//5:40 PM
			{RGB(25, 9, 1), 5},	//5:50 PM
		   },


	[18]  = {
			{RGB(22, 7, 10), 2},	//6:00 PM
			{RGB(20, 5, 12), 2},	//6:10 PM
			{RGB(18, 3, 13), 2},	//6:20 PM
			{RGB(16, 2, 14), 2},	//6:30 PM
			{RGB(14, 1, 15), 2},	//6:40 PM
